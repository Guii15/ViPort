    ...
    <SectionWrapper id="contato">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3 bg-secondary text-white px-8 py-4 rounded-full font-semibold text-lg hover:opacity-90 transition-opacity"
        >
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3 bg-text text-white px-8 py-4 rounded-full font-semibold text-lg hover:opacity-90 transition-opacity"
        >
