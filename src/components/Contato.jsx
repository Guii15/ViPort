...
export default function Contato() {
  return (
    <SectionWrapper id="contato">
      ...
      <p className="text-text-muted text-lg text-center mb-10">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        <a
          ...
          className="flex items-center gap-3 bg-green-500 text-white px-8 py-4 rounded-full font-semibold text-lg hover:opacity-90 transition-opacity"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-full font-semibold text-lg hover:opacity-90 transition-opacity"
        >
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
